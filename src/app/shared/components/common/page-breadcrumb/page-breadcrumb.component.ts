...
export class PageBreadcrumbComponent implements OnInit {
  ...
  private navigationStructure = {
    ...
    '/individual_beverage_sales': { main: 'Sales', sub: 'Manage Individual Beverage Sales' },
    '/new_nfc': { main: 'NFC', sub: 'New NFC'},
    '/nfc_details': { main: 'NFC', sub: 'NFC Details' },
    '/nfc_balance_topup': { main: 'NFC', sub: 'NFC Balance & Top-Up' },
    '/nfc_topup_history': { main: 'NFC', sub: 'NFC Top-Up History' },
    '/nfc_payment_refund_history': { main: 'NFC', sub: 'NFC Payment & Refund History' },
