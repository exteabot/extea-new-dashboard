...
<g transform="translate(0 -540.36)">
    ...
    {
      icon: `<svg fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M16,10a6,6,0,1,0,6,6A6,6,0,0,0,16,10Zm0,10a4,4,0,1,1,4-4A4,4,0,0,1,16,20Z"/>
      ...
      name: "Sales",
      subItems: [
        { name: "Manage Total Sales", path: "/beverage_sales" },
        { name: "Manage Beverage Sales", path: "/individual_beverage_sales" },
      ],
    },
    {
    ...
    <path d="M18.7224 20.5C20.2145 17.9157 21 14.9841 21 12C21 9.01588 20.2145 6.08433 18.7224 3.5" stroke="#33363F" stroke-width="2" stroke-linecap="round"/>
    <path d="M14.3923 18C15.4455 16.1758 16 14.1064 16 12C16 9.89356 15.4455 7.82423 14.3923 6" stroke="#33363F" stroke-width="2" stroke-linecap="round"/>
    <path d="M9.9282 16C10.6303 14.7838 11 13.4043 11 12C11 10.5957 10.6303 9.21615 9.9282 8" stroke="#33363F" stroke-width="2" stroke-linecap="round"/>
    <path d="M5.0718 16C4.36965 14.7838 4 13.4043 4 12C4 10.5957 4.36965 9.21615 5.0718 8" stroke="#33363F" stroke-width="2" stroke-linecap="round"/>
</svg>`,
      name: "NFC",
      subItems: [
        { name: "New NFC", path: "/new_nfc" },
        { name: "NFC Details", path: "/nfc_details" },
        { name: "Balance & Top-Up", path: "/nfc_balance_topup" },
        { name: "Top-Up History", path: "/nfc_topup_history" },
        { name: "Payment & Refund History", path: "/nfc_payment_refund_history" },
      ],
    },
    {
