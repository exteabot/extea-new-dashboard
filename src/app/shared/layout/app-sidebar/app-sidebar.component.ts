...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    <path d="M44.3,3H5.8C4.256,3,3,4.256,3,6.8v38.4C3,45.744,4.256,47,5.8,47h38.4c1.364,0,2.504-0.98,2.75-2.274 c0.095-0.152,0.149-0.333,0.149-0.525V5.8C47.1,4.256,45.844,3,44.3,3z M22,40h-3c0,1.1-1.3,2-3,2s-3-0.9-3-2h-3v-3h12V40z M40,40 H28v-3h12V40z M40,32H10V10h30V32z"/>
</svg>`,
      name: "Machines",
      subItems: [
